...
- [x] Add shareable project link that restores windows, measurements, configurations, samples, and checkout state
...
- [x] Apply codebase-refactor-hygiene-auditor final pass
